...
export default class FingerPoseEstimator {
  ...
  estimate(landmarks: { [x: string]: any; }) {
  ...
  getSlopes(point1: string | any[], point2: any[]) {
  ...
  angleOrientationAt(angle: number | number[], weightageAt = 1.0) {
  ...
  estimateFingerCurl(startPoint: number[], midPoint: number[], endPoint: number[]) {
  ...
  estimateHorizontalDirection(start_end_x_dist: number, start_mid_x_dist: number, mid_end_x_dist: number, max_dist_x: number) {
  ...
  estimateVerticalDirection(start_end_y_dist: number, start_mid_y_dist: number, mid_end_y_dist: number, max_dist_y: number) {
  ...
  estimateDiagonalDirection(
    start_end_y_dist: number, start_mid_y_dist: number, mid_end_y_dist: number, max_dist_y: number,
    start_end_x_dist: number, start_mid_x_dist: number, mid_end_x_dist: number, max_dist_x: number
  ) {
  ...
  calculateFingerDirection(startPoint: any[], midPoint: any[], endPoint: any[], fingerSlopes: any[]) {
  ...
  calculateSlope(point1x: number, point1y: number, point2x: number, point2y: number) {
